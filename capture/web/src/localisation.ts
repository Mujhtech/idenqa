export const CAPTURE_MESSAGE_KEYS = [
  ...
  "documentCaptureInstruction",
  "documentReviewInstruction",
  "documentFrontOf",
  "documentBackOf",
  "identityDocument",
  "documentHelp",
...
const englishMessages: Readonly<Record<CaptureMessageKey, string>> = {
  ...
  poseProgressLabel: "Current movement progress",
  poseFindFace: "Bring Your Face Into View",
  poseOneFace: "Only One Person at a Time",
  poseCenterFace: "Center Your Face in the Ring",
  poseMoveCloser: "Move a Little Closer",
  poseMoveBack: "Move a Little Further Back",
  poseFaceForward: "Look Straight Ahead to Begin",
  poseFollowPrompt: "Follow the Head Movement",
  poseHoldStill: "Hold Still…",
  poseOpenEyes: "Open Your Eyes",
  poseQuality: "Use Clear, Even Lighting and Hold Still",
  ...
  documentSearching: "Point the camera at the document.",
  documentAligning: "Move the document inside the guide.",
  documentMoveCloser: "Move the document closer.",
  documentHoldSteady: "Hold the camera steady.",
  documentReady: "Document found. Hold still while the photo is taken.",
  documentAutoCapture: "Automatic document capture is on",
  ...
  chooseDocumentTitle: "Which document will you use?",
  chooseDocumentBody: "Choose the identity document you have with you.",
  changeDocument: "Change document",
  savingDocument: "Saving your document choice…",
  documentSelectionFailed: "We couldn’t save that choice. Select your document to try again.",
  documentCaptureInstruction: "Take a clear photo of {item}.",
  documentReviewInstruction:
    "Make sure the lighting is good and all lettering is clear before continuing.",
  documentFrontOf: "the front of your {document}",
  documentBackOf: "the back of your {document}",
  identityDocument: "identity document",
  documentHelp: "Help",
  documentHelpBody:
    "Place your document on a flat surface in good light. Keep all four corners inside the guide, avoid glare, and make sure the lettering is readable.",
  documentFrontLabel: "Front of ID",
  documentBackLabel: "Back of ID",
};
