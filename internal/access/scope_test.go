	...
	tests := []struct {
		...
		},
		{
			...
			want: []access.Permission{
				...
				access.PermissionSupportAccessRead,
				access.PermissionTenantRead,
		...
		},
		{
			...
			want: []access.Permission{
				...
				access.PermissionBreakGlassRequest,
				access.PermissionBreakGlassUse,
				access.PermissionCaptureProfilesRead,
				access.PermissionCaptureProfilesWrite,
				access.PermissionConsentsRead,
				access.PermissionConsentsWrite,
				access.PermissionDecisionsExport,
				access.PermissionDecisionsRead,
				access.PermissionDeletionsRead,
				...
				access.PermissionEvidenceRead,
				access.PermissionEvidenceGrantsRead,
				access.PermissionEvidenceGrantsWrite,
				...
				access.PermissionSupportAccessRead,
				access.PermissionSupportAccessWrite,
